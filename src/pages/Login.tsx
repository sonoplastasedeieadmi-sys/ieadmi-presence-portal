      ...
      <div className="w-full max-w-md">
        <div className="bg-card rounded-2xl shadow-[var(--shadow-elevated)] p-8">
          <div className="flex flex-col items-center text-center mb-6">
            <div className="h-32 w-32 rounded-2xl bg-primary-soft flex items-center justify-center mb-4">
              <img src={logo} alt="Portal IEADMI Check-in" className="h-28 w-28 object-contain" />
            </div>

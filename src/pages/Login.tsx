      ...
      <div className="w-full max-w-md">
        <div className="bg-card rounded-2xl shadow-[var(--shadow-elevated)] p-8">
          <div className="flex flex-col items-center text-center mb-6">
            <div className="h-40 w-40 rounded-3xl bg-primary-soft flex items-center justify-center mb-4 shadow-[0_16px_40px_rgba(10,35,90,0.18)]">
              <img src={logo} alt="Portal IEADMI Check-in" className="h-32 w-32 object-contain" />
            </div>
